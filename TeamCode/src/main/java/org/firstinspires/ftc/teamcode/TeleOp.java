...
public class TeleOp extends CommandOpMode {
    ...
    public void initialize() {
        ...
        driver2.getGamepadButton(GamepadKeys.Button.B).whenPressed(intake::stopCollecting);
        driver2.getGamepadButton(GamepadKeys.Button.X).whenPressed(intake::startCollecting);
        ...
        schedule(
                ...
                new RunCommand(() -> {
                    ...
                    telemetry.addData("Wind", outtake.getArmState().toString());
