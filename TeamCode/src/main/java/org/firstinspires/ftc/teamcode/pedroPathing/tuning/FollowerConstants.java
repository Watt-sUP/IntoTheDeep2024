...
public class FollowerConstants {
    ...
    private static double xMovement = 69.19149637708715;
    private static double yMovement = 51.30054307643858;
    ...
    public static double translationalPIDFFeedForward = 0.025;
    ...
    public static double mass = 13.440;
    ...
    public static double forwardZeroPowerAcceleration = -32.2964376355275;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -72.4854163377522;
