package robotcode.pedroPathing.tuning;
...
import robotcode.pedroPathing.util.CustomFilteredPIDFCoefficients;
import robotcode.pedroPathing.util.CustomPIDFCoefficients;
import robotcode.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    public static double mass = 13.65;
    // Centripetal force to power scaling
    public static double centripetalScaling = 0.0003;
    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -26.389107035000766;
    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70.72531319149091;
    ...
    public static double zeroPowerAccelerationMultiplier = 16;
    ...
    // This can be custom set for each Path.
    public static double pathEndHeadingConstraint = 0.009;
    ...
    private static double xMovement = 67.67393097164124;
    private static double yMovement = 53.54693555456447;
