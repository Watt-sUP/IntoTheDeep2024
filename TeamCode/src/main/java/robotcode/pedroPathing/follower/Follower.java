package robotcode.pedroPathing.follower;

import static robotcode.pedroPathing.tuning.FollowerConstants.drivePIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.drivePIDFSwitch;
import static robotcode.pedroPathing.tuning.FollowerConstants.forwardZeroPowerAcceleration;
import static robotcode.pedroPathing.tuning.FollowerConstants.headingPIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.headingPIDFSwitch;
import static robotcode.pedroPathing.tuning.FollowerConstants.lateralZeroPowerAcceleration;
import static robotcode.pedroPathing.tuning.FollowerConstants.leftFrontMotorName;
import static robotcode.pedroPathing.tuning.FollowerConstants.leftRearMotorName;
import static robotcode.pedroPathing.tuning.FollowerConstants.rightFrontMotorName;
import static robotcode.pedroPathing.tuning.FollowerConstants.rightRearMotorName;
import static robotcode.pedroPathing.tuning.FollowerConstants.secondaryDrivePIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.secondaryHeadingPIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.secondaryTranslationalPIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.translationalPIDFFeedForward;
import static robotcode.pedroPathing.tuning.FollowerConstants.translationalPIDFSwitch;
import static robotcode.pedroPathing.tuning.FollowerConstants.useSecondaryDrivePID;
import static robotcode.pedroPathing.tuning.FollowerConstants.useSecondaryHeadingPID;
import static robotcode.pedroPathing.tuning.FollowerConstants.useSecondaryTranslationalPID;
...
import robotcode.pedroPathing.pathGeneration.BezierPoint;
import robotcode.pedroPathing.pathGeneration.MathFunctions;
import robotcode.pedroPathing.pathGeneration.Path;
import robotcode.pedroPathing.pathGeneration.PathBuilder;
import robotcode.pedroPathing.pathGeneration.PathCallback;
import robotcode.pedroPathing.pathGeneration.PathChain;
import robotcode.pedroPathing.pathGeneration.Point;
import robotcode.pedroPathing.pathGeneration.Vector;
import robotcode.pedroPathing.tuning.FollowerConstants;
import robotcode.pedroPathing.util.DashboardPoseTracker;
import robotcode.pedroPathing.util.Drawing;
import robotcode.pedroPathing.util.FilteredPIDFController;
import robotcode.pedroPathing.util.KalmanFilter;
import robotcode.pedroPathing.util.PIDFController;
